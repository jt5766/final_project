  ...
  <form action="/gallery/${content.gallery_cards}/contents/${content.seq}/modify/withFile" method="post"
    ...
    <form action="/gallery/${content.gallery_cards}/contents/${content.seq}/modify" method="post">
        ...
        <c:otherwise>
          <div class="row">
            <div class="col-md-12">
              ...
              <input type="file" name="file_image" id="input_file_image" onchange="readURL(this)"
                     formenctype="multipart/form-data">
              <input type="hidden" name="file_url" ${content.file_url}>
              <img src="${content.file_url}" alt="${content.file_url}" id="img">
            </div>
          </div>
        </c:otherwise>
      </c:choose>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <button type="button" onclick="location.href='/gallery/${content.gallery_cards}/contents/${content.seq}'">돌아가기</button>
        </div>
      </div>
    </form>
</div>
